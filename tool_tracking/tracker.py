...
from tool_tracking.cmkf import cmkf
from tool_tracking.ekf import ekf
...
from tool_tracking.imm import imm
...
#            self.thresholdEdit.setText("{}".format(self.trackerInfos.threshold))
    ...
    def loadTracker(self):
        ...
        self.tracker = tracker[self.filter.value](infos=self.trackerInfos)
